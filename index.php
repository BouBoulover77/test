	<!DOCTYPE html>
      ...
      try
	  {
		  ...
		  $bd = new PDO('mysql:host=localhost;dbname=cooking;charset=utf8', 'root', '');
	  }
	  catch(Exception $e)
	  {
       ...
       try
{
 $bdd = new PDO("mysql:host=localhost;dbname=cooking", "root", "");
				...
				<div class="container main-menu">
					<div class="row align-items-center justify-content-center d-flex">			
				      <nav id="nav-menu-container">
				        <ul class="nav-menu">
					   	  <li><a href="formulaire2.html">FORMULAIRE</a></li>
				          <li><a href="recettes.php">RECETTES</a></li>
				          <li><a href="about.html">MENUS</a></li>
				          <li><a href="menu.html">DESERTS</a></li>
				          <li><a href="gallery.html">MINCEURS</a></li>
                                          <li><a href="menu.html">ATELIER</a></li>
				...
				<div class="container">
					<div class="row fullscreen align-items-center justify-content-between">
						<div class="col-lg-12 banner-content">
							<h6 class="text-black">Bon Appétit !</h6>
							<h1 class="text-white">RECETTES DU JOUR</h1>
							<p class="text-white">
								miam miam, gloup gloup, laps laps
							</p>
							<a href="#" class="primary-btn text-uppercase">Consultez nos recettes</a>
						</div>
					</div>
				</div>					
			</section>
                    ...
                    <div class="filters-content">
                        <div class="row grid">
                            ...
                            <div class="col-md-6 all dinner">
								<div class="single-menu">
									<div class="title-wrap d-flex justify-content-between">
										<h4>Pommes de terre aux herbes</h4>
										<h4 class="price">$49</h4>
									</div>			
									<p>
										Usage of the Internet is becoming more common due to rapid advance.
                            ...
                            <div class="col-md-6 all breakfast">
								<div class="single-menu">
									<div class="title-wrap d-flex justify-content-between">
										<h4>Spécialités de Serge (best choice)</h4>
										<h4 class="price">$9899</h4>
									</div>
									<p>
										Usage of the Internet is becoming more common due to rapid advance.
									</p>									
